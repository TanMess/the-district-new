 ...
 */
final class Version20240904130454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flat CHANGE active active TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flat CHANGE active active TINYINT(1) NOT NULL');
    }
}
